...
-- Única inserção das categorias de sistema — 0001_initial_schema.sql não
-- insere mais essas linhas, pra evitar a duplicidade (unique constraint)
-- que acontecia quando schema e seed rodavam os dois.
